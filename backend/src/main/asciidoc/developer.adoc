...
Contains a service that uses the https://www.rki.de/DE/Content/Infekt/IfSG/Software/Aktueller_Datenbestand.html[data from RKI] to offer the search for health departments by zip code or location.
