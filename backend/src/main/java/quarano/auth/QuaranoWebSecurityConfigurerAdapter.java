...
import quarano.auth.validation.JwtAuthenticationEntryPoint;
import quarano.auth.validation.JwtAuthenticationProvider;
import quarano.auth.validation.JwtAuthenticationTokenFilter;
...
public class QuaranoWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        .antMatchers("/registration/checkusername/**").permitAll()
