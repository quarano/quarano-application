 ...
 * {@link IdentifierProcessor} implementations can be registered with it to pre- and post process the source and target
 * identifier values obtained from source and target objects.
 *
 * @author Oliver Drotbohm
 */
public interface IdentifierProcessor extends Plugin<Class<?>> {
	 ...
	 * @return will never be {@literal null}.
	 */
	default Object postProcessIdentifier(Object identifier, Class<?> sourceType) {
		return identifier;
	}
