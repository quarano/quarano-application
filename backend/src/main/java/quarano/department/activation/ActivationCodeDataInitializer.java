...
public class ActivationCodeDataInitializer implements DataInitializer {
	...
	public static final ActivationCode ACTIVATIONCODE_SEC5_OPEN = new ActivationCode(
			LocalDateTime.of(2025, 10, 10, 0, 0), TrackedPersonDataInitializer.VALID_TRACKED_SEC5_ID_DEP1,
			DepartmentDataInitializer.DEPARTMENT_ID_DEP1,
			ActivationCodeIdentifier.of(UUID.fromString("4cf65303-1ad1-4659-80bd-6231839afc47")));
	
	public static final ActivationCode ACTIVATIONCODE_SEC6_OPEN = new ActivationCode(
			LocalDateTime.of(2025, 10, 10, 0, 0), TrackedPersonDataInitializer.VALID_TRACKED_SEC6_ID_DEP1,
			DepartmentDataInitializer.DEPARTMENT_ID_DEP1,
			ActivationCodeIdentifier.of(UUID.fromString("7e4cac7e-8924-4a7f-b209-8eefe25a06c6")));
	
	public static final ActivationCode ACTIVATIONCODE_SEC7_OPEN = new ActivationCode(
			LocalDateTime.of(2025, 10, 10, 0, 0), TrackedPersonDataInitializer.VALID_TRACKED_SEC7_ID_DEP1,
			DepartmentDataInitializer.DEPARTMENT_ID_DEP1,
			ActivationCodeIdentifier.of(UUID.fromString("a594e8df-1932-455c-a755-8362731a9aeb")));
	
	public static final ActivationCode ACTIVATIONCODE_SEC8_OPEN = new ActivationCode(
			LocalDateTime.of(2025, 10, 10, 0, 0), TrackedPersonDataInitializer.VALID_TRACKED_SEC8_ID_DEP1,
			DepartmentDataInitializer.DEPARTMENT_ID_DEP1,
