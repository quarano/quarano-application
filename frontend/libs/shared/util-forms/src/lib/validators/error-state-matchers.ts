...
export class ConfirmValidPasswordMatcher implements ErrorStateMatcher {
  isErrorState(control: FormControl | null, form: FormGroupDirective | NgForm | null): boolean {
    return !!PasswordValidator.mustMatch(control.parent as FormGroup) || (control.invalid && control.touched);
  }
}
...
export class PasswordIncludesUsernameMatcher implements ErrorStateMatcher {
  isErrorState(control: FormControl | null, form: FormGroupDirective | NgForm | null): boolean {
    return (
      !!PasswordValidator.mustNotIncludeUsername(control.parent as FormGroup) || (control.invalid && control.touched)
    );
  }
}
