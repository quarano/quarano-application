...
export const roles: IRole[] = [
  ...
  {
    name: roleNames.healthDepartmentAdmin,
    isHealthDepartmentUser: true,
    isAdmin: true,
    displayName: 'Gesundheitsamtsadmin',
  },
  {
    name: roleNames.healthDepartmentCaseAgent,
    isHealthDepartmentUser: true,
    isAdmin: false,
    displayName: 'Fallbearbeiter',
  },
