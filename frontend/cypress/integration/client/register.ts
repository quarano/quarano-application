...
describe('registration form', () => {
    ...
    describe('validation', () => {
        ...
        describe('input values are validated', () => {
            describe('e-mail', () => {
                it('invalid value', () => {
                    cy.get('[data-cy="input-email"] input[matInput]').type('asdasd').blur().then($input => {
                        $input.hasClass('mat-form-field-invalid');
                ...
                it('valid value', () => {
                    cy.get('[data-cy="input-email"] input[matInput]').type('test@mustermann.de').blur().then($input => {
