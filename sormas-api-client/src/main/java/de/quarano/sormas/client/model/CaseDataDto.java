...
public class CaseDataDto {
	@JsonProperty("creationDate") private OffsetDateTime creationDate = null;

	@JsonProperty("changeDate") private OffsetDateTime changeDate = null;

	@JsonProperty("uuid") private String uuid = null;

	@JsonProperty("pseudonymized") private Boolean pseudonymized = null;

	@JsonProperty("disease") private Disease disease = null;

	@JsonProperty("diseaseDetails") private String diseaseDetails = null;

	@JsonProperty("plagueType") private PlagueType plagueType = null;

	@JsonProperty("dengueFeverType") private DengueFeverType dengueFeverType = null;

	@JsonProperty("rabiesType") private RabiesType rabiesType = null;

	@JsonProperty("person.lastName") private String name = null;

	@JsonProperty("person") private PersonReferenceDto person = null;

	@JsonProperty("epidNumber") private String epidNumber = null;

	@JsonProperty("reportDate") private OffsetDateTime reportDate = null;

	@JsonProperty("reportingUser") private UserReferenceDto reportingUser = null;

	@JsonProperty("regionLevelDate") private OffsetDateTime regionLevelDate = null;

	@JsonProperty("nationalLevelDate") private OffsetDateTime nationalLevelDate = null;

	@JsonProperty("districtLevelDate") private OffsetDateTime districtLevelDate = null;

	@JsonProperty("caseClassification") private CaseClassification caseClassification = null;

	@JsonProperty("classificationUser") private UserReferenceDto classificationUser = null;

	@JsonProperty("classificationDate") private OffsetDateTime classificationDate = null;

	@JsonProperty("classificationComment") private String classificationComment = null;

	@JsonProperty("investigationStatus") private InvestigationStatus investigationStatus = null;

	@JsonProperty("investigatedDate") private OffsetDateTime investigatedDate = null;

	@JsonProperty("outcome") private CaseOutcome outcome = null;

	@JsonProperty("outcomeDate") private OffsetDateTime outcomeDate = null;

	@JsonProperty("sequelae") private YesNoUnknown sequelae = null;

	@JsonProperty("sequelaeDetails") private String sequelaeDetails = null;

	@JsonProperty("region") private RegionReferenceDto region = null;

	@JsonProperty("district") private DistrictReferenceDto district = null;

	@JsonProperty("community") private CommunityReferenceDto community = null;

	@JsonProperty("healthFacility") private FacilityReferenceDto healthFacility = null;

	@JsonProperty("healthFacilityDetails") private String healthFacilityDetails = null;

	@JsonProperty("pregnant") private YesNoUnknown pregnant = null;

	@JsonProperty("vaccination") private Vaccination vaccination = null;

	@JsonProperty("vaccinationDoses") private String vaccinationDoses = null;

	@JsonProperty("vaccinationDate") private OffsetDateTime vaccinationDate = null;

	@JsonProperty("vaccinationInfoSource") private VaccinationInfoSource vaccinationInfoSource = null;

	@JsonProperty("vaccine") private String vaccine = null;

	@JsonProperty("smallpoxVaccinationScar") private YesNoUnknown smallpoxVaccinationScar = null;

	@JsonProperty("smallpoxVaccinationReceived") private YesNoUnknown smallpoxVaccinationReceived = null;

	@JsonProperty("surveillanceOfficer") private UserReferenceDto surveillanceOfficer = null;

	@JsonProperty("clinicianName") private String clinicianName = null;

	@JsonProperty("clinicianPhone") private String clinicianPhone = null;

	@JsonProperty("clinicianEmail") private String clinicianEmail = null;

	@JsonProperty("notifyingClinic") private HospitalWardType notifyingClinic = null;

	@JsonProperty("notifyingClinicDetails") private String notifyingClinicDetails = null;

	@JsonProperty("caseOfficer") private UserReferenceDto caseOfficer = null;

	@JsonProperty("reportLat") private Double reportLat = null;

	@JsonProperty("reportLon") private Double reportLon = null;

	@JsonProperty("reportLatLonAccuracy") private Float reportLatLonAccuracy = null;

	@JsonProperty("hospitalization") private HospitalizationDto hospitalization = null;

	@JsonProperty("symptoms") private SymptomsDto symptoms = null;

	@JsonProperty("epiData") private EpiDataDto epiData = null;

	@JsonProperty("therapy") private TherapyDto therapy = null;

	@JsonProperty("clinicalCourse") private ClinicalCourseDto clinicalCourse = null;

	@JsonProperty("maternalHistory") private MaternalHistoryDto maternalHistory = null;

	@JsonProperty("creationVersion") private String creationVersion = null;

	@JsonProperty("portHealthInfo") private PortHealthInfoDto portHealthInfo = null;

	@JsonProperty("caseOrigin") private CaseOrigin caseOrigin = null;

	@JsonProperty("pointOfEntry") private PointOfEntryReferenceDto pointOfEntry = null;

	@JsonProperty("pointOfEntryDetails") private String pointOfEntryDetails = null;

	@JsonProperty("additionalDetails") private String additionalDetails = null;

	@JsonProperty("externalID") private String externalID = null;

	@JsonProperty("sharedToCountry") private Boolean sharedToCountry = null;

	@JsonProperty("quarantine") private QuarantineType quarantine = null;

	@JsonProperty("quarantineTypeDetails") private String quarantineTypeDetails = null;

	@JsonProperty("quarantineFrom") private OffsetDateTime quarantineFrom = null;

	@JsonProperty("quarantineTo") private OffsetDateTime quarantineTo = null;

	@JsonProperty("quarantineHelpNeeded") private String quarantineHelpNeeded = null;

	@JsonProperty("quarantineOrderedVerbally") private Boolean quarantineOrderedVerbally = null;

	@JsonProperty("quarantineOrderedOfficialDocument") private Boolean quarantineOrderedOfficialDocument = null;

	@JsonProperty("quarantineOrderedVerballyDate") private OffsetDateTime quarantineOrderedVerballyDate = null;

	@JsonProperty("quarantineOrderedOfficialDocumentDate") private OffsetDateTime quarantineOrderedOfficialDocumentDate = null;

	@JsonProperty("quarantineHomePossible") private YesNoUnknown quarantineHomePossible = null;

	@JsonProperty("quarantineHomePossibleComment") private String quarantineHomePossibleComment = null;

	@JsonProperty("quarantineHomeSupplyEnsured") private YesNoUnknown quarantineHomeSupplyEnsured = null;

	@JsonProperty("quarantineHomeSupplyEnsuredComment") private String quarantineHomeSupplyEnsuredComment = null;

	@JsonProperty("reportingType") private ReportingType reportingType = null;

	@JsonProperty("postpartum") private YesNoUnknown postpartum = null;

	@JsonProperty("trimester") private Trimester trimester = null;

	@JsonProperty("unreferredPortHealthCase") private Boolean unreferredPortHealthCase = null;
	...
	@Override
	public int hashCode() {
		return Objects.hash(creationDate, changeDate, uuid, pseudonymized, disease, diseaseDetails, plagueType,
				dengueFeverType, rabiesType, person, epidNumber, reportDate, reportingUser, regionLevelDate, nationalLevelDate,
				districtLevelDate, caseClassification, classificationUser, classificationDate, classificationComment,
				investigationStatus, investigatedDate, outcome, outcomeDate, sequelae, sequelaeDetails, region, district,
				community, healthFacility, healthFacilityDetails, pregnant, vaccination, vaccinationDoses, vaccinationDate,
				vaccinationInfoSource, vaccine, smallpoxVaccinationScar, smallpoxVaccinationReceived, surveillanceOfficer,
				clinicianName, clinicianPhone, clinicianEmail, notifyingClinic, notifyingClinicDetails, caseOfficer, reportLat,
				reportLon, reportLatLonAccuracy, hospitalization, symptoms, epiData, therapy, clinicalCourse, maternalHistory,
				creationVersion, portHealthInfo, caseOrigin, pointOfEntry, pointOfEntryDetails, additionalDetails, externalID,
				sharedToCountry, quarantine, quarantineTypeDetails, quarantineFrom, quarantineTo, quarantineHelpNeeded,
				quarantineOrderedVerbally, quarantineOrderedOfficialDocument, quarantineOrderedVerballyDate,
				quarantineOrderedOfficialDocumentDate, quarantineHomePossible, quarantineHomePossibleComment,
				quarantineHomeSupplyEnsured, quarantineHomeSupplyEnsuredComment, reportingType, postpartum, trimester,
				unreferredPortHealthCase);
	}
	...
	public String toString() {
		...
		sb.append("    quarantineOrderedOfficialDocument: ").append(toIndentedString(quarantineOrderedOfficialDocument))
				.append("\n");
		sb.append("    quarantineOrderedVerballyDate: ").append(toIndentedString(quarantineOrderedVerballyDate))
				.append("\n");
		sb.append("    quarantineOrderedOfficialDocumentDate: ")
				.append(toIndentedString(quarantineOrderedOfficialDocumentDate)).append("\n");
		sb.append("    quarantineHomePossible: ").append(toIndentedString(quarantineHomePossible)).append("\n");
		sb.append("    quarantineHomePossibleComment: ").append(toIndentedString(quarantineHomePossibleComment))
				.append("\n");
		sb.append("    quarantineHomeSupplyEnsured: ").append(toIndentedString(quarantineHomeSupplyEnsured)).append("\n");
		sb.append("    quarantineHomeSupplyEnsuredComment: ").append(toIndentedString(quarantineHomeSupplyEnsuredComment))
				.append("\n");
