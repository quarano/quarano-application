...
public class PrescriptionControllerApi {
    ...
    public PrescriptionControllerApi() {
        this(new ApiClient());
    }

    @Autowired
    public PrescriptionControllerApi(ApiClient apiClient) {
     ...
     */
    public List<String> getAllActiveUuids6() throws RestClientException {
        Object postBody = null;
        String path = UriComponentsBuilder.fromPath("/prescriptions/uuids").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public List<PrescriptionDto> getAllPrescriptions(Long since) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'since' is set
        if (since == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'since' when calling getAllPrescriptions");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("since", since);
        String path = UriComponentsBuilder.fromPath("/prescriptions/all/{since}").buildAndExpand(uriVariables).toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public List<PushResult> postPrescriptions(List<PrescriptionDto> body) throws RestClientException {
        Object postBody = body;
        String path = UriComponentsBuilder.fromPath("/prescriptions/push").build().toUriString();
