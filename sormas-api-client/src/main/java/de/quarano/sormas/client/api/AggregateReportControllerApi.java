...
public class AggregateReportControllerApi {
    ...
    public List<AggregateReportDto> getAllAggregateReports(Long since) throws RestClientException {
        ...
        if (since == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'since' when calling getAllAggregateReports");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("since", since);
        String path = UriComponentsBuilder.fromPath("/aggregatereports/all/{since}").buildAndExpand(uriVariables).toUriString();
