...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2020-12-15T22:47:05.366577+01:00[Europe/Berlin]")@Component("de.quarano.sormas.client.api.CampaignFormMetaControllerApi")
public class CampaignFormMetaControllerApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public List<CampaignFormMetaDto> getByUuids4(List<String> body) throws RestClientException {
