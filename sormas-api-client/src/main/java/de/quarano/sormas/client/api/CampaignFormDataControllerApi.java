...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2020-12-15T22:47:05.366577+01:00[Europe/Berlin]")@Component("de.quarano.sormas.client.api.CampaignFormDataControllerApi")
public class CampaignFormDataControllerApi {
    ...
    public List<CampaignFormDataDto> getAllCampaignFormData(Long since) throws RestClientException {
        ...
        if (since == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'since' when calling getAllCampaignFormData");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("since", since);
        String path = UriComponentsBuilder.fromPath("/campaignFormData/all/{since}").buildAndExpand(uriVariables).toUriString();
