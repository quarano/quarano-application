...
public class MaternalHistoryDto {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(creationDate, changeDate, uuid, pseudonymized, childrenNumber, ageAtBirth, conjunctivitis, conjunctivitisOnset, conjunctivitisMonth, maculopapularRash, maculopapularRashOnset, maculopapularRashMonth, swollenLymphs, swollenLymphsOnset, swollenLymphsMonth, arthralgiaArthritis, arthralgiaArthritisOnset, arthralgiaArthritisMonth, otherComplications, otherComplicationsOnset, otherComplicationsMonth, otherComplicationsDetails, rubella, rubellaOnset, rashExposure, rashExposureDate, rashExposureMonth, rashExposureRegion, rashExposureDistrict, rashExposureCommunity);
  }
